    ...
    <div className="animate-in fade-in duration-300 max-w-4xl pt-2">
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="flex-1 max-w-2xl prose prose-slate">
          <div className="mb-10">
            <h2 className="text-3xl font-extrabold text-[var(--color-on-surface)] tracking-tight leading-tight mb-3">Privacy Policy</h2>
          ...
          <div className="space-y-10 text-[15px] text-[var(--color-on-surface-variant)] leading-relaxed">
            ...
            <section id="information-we-collect">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">1. Information We Collect</h3>
            ...
            <section id="how-we-use">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">2. How We Use Information</h3>
            ...
            <section id="data-storage">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">3. Data Storage & Security</h3>
            ...
            <section id="email-communications">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">4. Email Communications</h3>
            ...
            <section id="third-party">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">5. Third-Party Services</h3>
            ...
            <section id="user-rights">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">6. User Rights</h3>
            ...
            <section id="contact">
              <h3 className="text-[20px] font-bold text-[var(--color-on-surface)] mb-4">7. Contact Information</h3>
