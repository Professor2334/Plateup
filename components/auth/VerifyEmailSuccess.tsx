    ...
    <div className="w-full text-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-[var(--color-on-surface-variant)] text-[16px] leading-relaxed mb-10 max-w-[340px] mx-auto">
          Welcome to PlateUp. Your email has been verified and you're ready to start planning smarter Nigerian meals.
        </p>
        ...
        <div className="w-full flex items-center justify-between relative mb-12 px-2">
          ...
          <div className="absolute left-6 right-1/2 top-1/2 -translate-y-1/2 h-0.5 bg-[var(--color-primary)] -z-10" />
          ...
          {/* Step 3 */}
          <div className="flex flex-col items-center gap-2 bg-white px-2">
            <div className="w-7 h-7 rounded-full bg-white border-2 border-[var(--color-outline)] text-[var(--color-outline)] flex items-center justify-center">
              <div className="w-2 h-2 rounded-full bg-transparent" />
            </div>
            <span className="text-[12px] font-medium text-[var(--color-on-surface-variant)] text-center max-w-[80px] leading-tight opacity-70">Household Setup</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 bg-white px-2">
            ...
            <span className="text-[12px] font-medium text-[var(--color-on-surface-variant)] text-center max-w-[80px] leading-tight opacity-70">First Meal Plan</span>
          </div>
        </div>
