    ...
    return (
      <div className="w-full space-y-8 animate-in fade-in duration-500">
        ...
        <Link href="/auth/login" className="block w-full">
          <Button type="button" variant="outline" className="w-full min-h-[48px] rounded-xl font-bold border-[color-mix(in_srgb,var(--color-outline-variant)_50%,transparent)]">
    ...
    <div className="w-full space-y-8 animate-in fade-in duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="pt-2 flex flex-col gap-3">
          ...
          <Link href="/auth/login" className="block w-full">
            <Button type="button" variant="outline" className="w-full min-h-[48px] rounded-xl font-semibold text-[var(--color-on-surface-variant)] hover:text-[var(--color-on-surface)] border-transparent shadow-none bg-transparent hover:bg-[var(--color-surface-container-low)]">
              <ArrowLeft className="w-4 h-4 mr-2 inline-block" />
              Back to Login
            </Button>
          </Link>
